...
public static void main(String[] args) throws Exception{
	...
	//Message secret
	String message = "la sécurité ce n'est pas éliminer le danger mais mieux le connaitre";
	...
	boolean isCorrect = verify(getMD5Checksum("signature.class"), signature, pair.getPublic());
	...
	boolean isWrong = verify(getMD5Checksum("signature.java"), signature, pair.getPublic());
